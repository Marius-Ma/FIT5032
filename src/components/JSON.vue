...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- <ul>
        <li v-for="i in authors">{{ i.name }} {{ i.birthYear }}</li>
      </ul> -->
      <ul>
      ...
      <ul>
        <li v-for="famousWork in austen.famousWorks" :key="famousWork">
          {{ famousWork.title }}
        </li>
      </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(timeType, dayType) in bookstores.openingHours" :key="dayType">
          {{ dayType }} : {{ timeType.open }} - {{ timeType.close }}
        </li>
      </ul>
