...
const validateReason = (blur) => {
  ...
  if (reason.length < minLength) {
    ...
    errors.value.reasonType = 'error'
  } else if (reason.includes('friend')) {
    errors.value.reason = 'Great to have a friend'
    errors.value.reasonType = 'positive'
  } else {
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="errors.reason && errors.reasonType === 'error'" class="text-danger">
              {{ errors.reason }}
            </div>
            <div v-if="errors.reason && errors.reasonType === 'positive'" class="text-success">
              {{ errors.reason }}
            </div>
            <div class="mt-3 mb-3">
